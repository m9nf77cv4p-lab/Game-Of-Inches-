...
The GitHub Action runs every five minutes and can also be started manually. It runs unit tests first, validates the Sleeper league identity and dynasty format, then writes only when source data changes.
